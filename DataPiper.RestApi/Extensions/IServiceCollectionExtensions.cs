...
namespace DataPiper
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddRestApiSource(this IServiceCollection services, IConfiguration configSection, string name = null)
        {
            if(name != null)
                return services.AddTransient<RestApiSource>().Configure<RestApiSourceOptions>(name, configSection);
            return services.AddTransient<RestApiSource>().Configure<RestApiSourceOptions>(configSection);
        }
    }
}
